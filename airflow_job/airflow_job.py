...
with DAG(
    ...
    gcs_bucket = Variable.get("gcs_bucket", default_var="airflow-projects-bucket-v1")
    bq_project = Variable.get("bq_project", default_var="project-19330bef-483f-4dc8-bf6")
    ...
    batch_details = {
        ...
        "environment_config": {
            "execution_config": {
                "service_account": "611054035776-compute@developer.gserviceaccount.com",
                "network_uri": "projects/project-19330bef-483f-4dc8-bf6/global/networks/default",
                "subnetwork_uri": "projects/project-19330bef-483f-4dc8-bf6/regions/europe-west1/subnetworks/default",
            }
        },
    }
    ...
    pyspark_task = DataprocCreateBatchOperator(
        ...
        batch=batch_details,
        batch_id=batch_id,
        project_id="project-19330bef-483f-4dc8-bf6",
        region="europe-west1",
